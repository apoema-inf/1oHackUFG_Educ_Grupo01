							...
							<div class="form-group">
								...
								<div class="col-md-5 inputGroupContainer">
									<div class="input-group">
										...
										<input required  name="areas_descricao" value="<?= $areas['areas_descricao']; ?>" placeholder="Nome" required data-bv-notempty-message="Você deve informar uma areas!" class="form-control"  type="text">
									</div>
								</div>
							</div>
