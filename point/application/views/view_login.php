...
<head>
  ...
  <title>Point Eventos | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href=""><b>Point </b>Eventos - UFG</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Entre com a sua senha</p>

    <?php echo form_open('index.php/autenticar'); ?>
    <?php echo validation_errors(); ?>
      <div class="form-group has-feedback">
        <input type="email" class="form-control" name="usuarios_email" placeholder="E-mail ou CPF">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="usuarios_senha" placeholder="Senha">
    ...
    <a href="#" class="text-center">Ainda não sou cadastrado! Cadastrar</a>
